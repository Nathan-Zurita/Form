            ...
            <div class="card-body sindppenal-header">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                    ...
                    <div class="d-flex flex-wrap gap-2 sindppenal-btn-group">
                        ...
                        <a href="notificacao_email.php" class="btn btn-primary btn-sm">
                            <img src="../assets/icons/formulario/email.svg" alt="Emails Notificações" class="svg-icon-white size-sm">
                            Emails Notificações
                        </a>
