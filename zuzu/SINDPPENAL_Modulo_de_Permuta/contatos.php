...
Auth::requireAuth();xckjvxckvjhxcvjhcxvghcvghxcv
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="email" class="form-label fw-semibold">
                                        <img src="../assets/icons/formulario/email.svg" alt="Email" class="svg-icon size-sm">
                                        Email:
                                    </label>
                                    <input type="email" id="email" name="email" class="form-control" 
                                           placeholder="email@exemplo.com"
                                           value="<?php echo $contato_edit ? htmlspecialchars($contato_edit['email'] ?? '') : ''; ?>">
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="sexo" class="form-label fw-semibold">
                                        <img src="../assets/icons/formulario/user.svg" alt="Sexo" class="svg-icon size-sm">
                                        Sexo:
                                    </label>
                                    <select id="sexo" name="sexo" class="form-select" required>
                                        <option value="">Selecione o sexo</option>
                                        <option value="M" <?php echo ($contato_edit && ($contato_edit['sexo'] ?? '') === 'M') ? 'selected' : ''; ?>>Masculino</option>
                                        <option value="F" <?php echo ($contato_edit && ($contato_edit['sexo'] ?? '') === 'F') ? 'selected' : ''; ?>>Feminino</option>
                                    </select>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select id="destino" name="destino[]" multiple="multiple" class="form-select" >
                                        <?php
                                        if ($contato_edit):
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="input-group">
                                        <input type="text" 
                                            class="form-control" 
                                            name="search" 
                                       placeholder="Buscar por nome, número funcional, telefone, email, origem ou destino..."
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo htmlspecialchars($contato['sexo'] === 'M' ? 'Masculino' : ($contato['sexo'] === 'F' ? 'Feminino' : '-')); ?></td>
